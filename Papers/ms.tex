...
95\% posterior probability, is $5.21 M_\odot$.
...
\caption{The joint posterior distribution for the SIE mass (integrated within
its critical ellipse, which is not the critical curve of the lens overall),
and the total mass in substructures. Assuming a flat cosmology with
$\Omega_m=0.3$, $\Omega_\Lambda=0.7$, and
$H_0=70$ km/s/Mpc, one mass unit corresponds to 2.07$\times 10^{11} M_\odot$.
\label{fig:masses2}}
\end{center}
\end{figure}
...
captured by the simple external shear model.
