...
We demonstrate the method on two
simulated data sets: one with a single
substructure, and one with ten. We also
apply the method to the g-band
image of the ``Cosmic Horseshoe'' system, and find evidence for more
than zero substructures. However, these have large spatial
