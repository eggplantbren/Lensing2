...
of the Cosmic Horseshoe \citep{2008MNRAS.388..384D} taken with the Isaac Newton Telescope (INT). The image is shown in Figure~\ref{fig:horseshoe_image}.
For this system,
...
\caption{The X-band INT image of the Cosmic Horseshoe.
