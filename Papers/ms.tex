...
substructure. The image is shown in Figure~\ref{fig:simulated_image}.

\begin{figure}
\begin{center}
\includegraphics[scale=0.5]{simulated_image.pdf}
\caption{\label{fig:simulated_image}}
\end{center}
\end{figure}

\section{The Cosmic Horseshoe}
As a further demonstration the method, we apply it to the X-band INT
image of the Cosmic Horseshoe \citep{}, which is shown in
Figure~\ref{fig:horseshoe_image}.
