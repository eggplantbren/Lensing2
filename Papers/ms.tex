...
The image is shown in Figure~\ref{fig:simulated_image}, and
...
lens in the center of the image (which does not contribute any flux), plus a
single substructure close to the top left image.
The image was blurred by a PSF and had some noise added.\label{fig:simulated_image}}
\end{center}
\end{figure}
