...
f(x, y) &=& \left\{
\begin{array}{lr}
\frac{2A}{\pi w^2}\left[1 - \left(\frac{r}{w}\right)^2\right], & r \leq w\\
...
\begin{array}{lr}
\frac{2A_i}{\pi w_i^2}\left[1 - \left(\frac{r_i}{w_i}\right)^2\right], & r_i \leq w_i\\
0, & \textnormal{otherwise}
\end{array}
\right.
\end{eqnarray}
...
\rho(x, y) &=& \left\{
\begin{array}{lr}
\frac{2M}{\pi v^2}\left[1 - \left(\frac{r}{v}\right)^2\right], & r \leq v\\
0, & \textnormal{otherwise}
\end{array}
\right.
\end{eqnarray}
...
\left\{
\begin{array}{lr}
\left[2 - (r/v)^2\right]\frac{Mx}{\pi v^2}, & r \leq v\\
...
\left\{
\begin{array}{lr}
\left[2 - (r/v)^2\right]\frac{My}{\pi v^2}, & r \leq v\\
