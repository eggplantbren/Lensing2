...
The SIE+$\gamma$ has nine parameters:
...
$\mu_{\rm src}$ &	Typical flux of source blobs	& $\ln(\mu_{\rm src}) \sim$ Cauchy(0, 1)T(-21, 21)\\
$\mu_{\rm lens}$&	Typical mass of lens blobs	& $\ln(\mu_{\rm lens}) \sim$ Cauchy(0, 1)T(-21, 21)\\
...
\hline
$b$ & SIE Einstein Radius & \\
$q$ & Axis ratio\\
$(x_c^{\rm SIE}, y_c^{\rm SIE})$ & Central position\\
$\theta$ & Orientation angle\\
$\gamma$ & External shear\\
$\theta_\gamma$ & External shear angle\\
\hline
{\bf Noise Parameters}\\
\hline
$\sigma_0$ & Constant component of noise variance\\
$\sigma_1$ & \\
\hline
{\bf Data}\\
\hline
$D_{ij}$ & Pixel intensities & Normal()
\end{tabular}
